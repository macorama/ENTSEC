...
package com.jmarkoff.entsec;

import android.security.keystore.KeyProperties;

import com.jmarkoff.entsec.config.TrustAnchorOptions;

import static com.jmarkoff.entsec.config.TrustAnchorOptions.USER_SYSTEM;
...
public class SecureConfig {
    ...
    private TrustAnchorOptions trustAnchorOptions = USER_SYSTEM;
    ...
    public static SecureConfig getStrongConfig() {
        ...
        builder.trustAnchorOptions = USER_SYSTEM;
