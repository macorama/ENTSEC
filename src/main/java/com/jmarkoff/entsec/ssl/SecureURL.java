...
import com.jmarkoff.entsec.config.TLD;
...
public class SecureURL {
    ...
    public SecureURL(String spec, String clientCertAlias, SecureConfig secureConfig) throws MalformedURLException {
    ...
    public URLConnection openConnection() throws IOException {
        ...
        urlConnection.setSSLSocketFactory(new SecureSSLSocketFactory(this));
        return urlConnection;
    }

    public URLConnection openUserTrustedCertConnection(Map<String, InputStream> trustedCAs) throws IOException {
        HttpsURLConnection urlConnection = (HttpsURLConnection) this.url.openConnection();
        urlConnection.setSSLSocketFactory(new SecureSSLSocketFactory(this, trustedCAs, secureConfig));
        return urlConnection;
    }
                ...
                try {
                    ...
                    if (subAltNames != null) {
                        ...
                        for (String dnsName : dnsNames) {
                            if (TLD.VALID_TLDS.contains(dnsName)) {
                                Log.i(TAG, "FAILED WILDCARD TLD CHECK: " + dnsName);
                                return false;
                            }
                        }
                    }
